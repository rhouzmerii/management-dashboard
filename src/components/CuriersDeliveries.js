            ...
            <table>
              <thead>
                <IconContext.Provider value={{ size: "12px" }}>
                  <tr className=" pl-3 bg-[#f7f7f7]">
                    ...
                    <td>
                      <div className="flex gap-2 items-center">
                        <h6 className="text-[12px] lg:text-[14px]">Name of Client</h6>
                        <div>
                          <AiFillCaretUp />
                          <AiFillCaretDown />
                        </div>
              ...
              <tbody>
                <tr className="">
                  ...
                  <td data-label=" CURIER" className="px-3 ">
                    {" "}
                    <h6 className="text-[14px]">Name</h6>
                  </td>
                  <td data-label="Name of Client" className=" px-3">
                    <h6 className="text-[14px]">Name</h6>
                  </td>
...
export default CuriersDeliveries;
