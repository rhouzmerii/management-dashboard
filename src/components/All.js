      ...
      <IconContext.Provider value={{ size: "10px" }}>
        ...
        <table style={{ width: "100%" }}>
          ...
          <tr className="pl-6 border-[1px] border-b-[#f7f7f7]">
            ...
            <td>
              <div className="flex gap-2 items-center">
                <h6 className="text-[14px] bg-red-300 p-1 rounded-[10px] text-red-500 font-bold">Cancelled</h6>
              </div>
            </td>
          ...
          <tr className="pl-6 border-[1px] border-b-[#f7f7f7]">
            ...
            <td>
              <div className="flex gap-2 items-center">
                <h6 className="text-[14px] bg-gray-300 p-1 rounded-[10px] text-gray-500 font-bold">Closed</h6>
              </div>
            </td>
          ...
          <tr className="pl-6 border-[1px] border-b-[#f7f7f7]">
            ...
            <td>
              <div className="flex gap-2 items-center">
                <h6 className="text-[14px] bg-gray-300 p-1 rounded-[10px] text-gray-500 font-bold">Drooped</h6>
              </div>
            </td>
          ...
          <tr className="pl-6 bg-yellow-200 border-[1px] border-b-[#f7f7f7]">
            ...
            <td>
              <div className="flex gap-2 items-center">
                <h6 className="text-[14px] bg-green-300 p-1 rounded-[10px] text-green-500 font-bold">Delievred</h6>
              </div>
            </td>
